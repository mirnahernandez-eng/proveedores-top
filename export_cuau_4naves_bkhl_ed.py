"""
export_cuau_4naves_bkhl_ed.py
Cuautitlan — 4 hojas: CUAUTITLAN (N1+N2), NAVE 1, NAVE 2, NAVE 3 (det. 7492)
BKHL + Entregas Directas lado a lado.
Genera DOS archivos: junio 2026 y julio 1-10 2026.
Uso: python export_cuau_4naves_bkhl_ed.py
"""
import re, warnings
import pandas as pd
import numpy as np
...
# Rango total de consulta; se divide en Python
...
ALL_NAMES = [r[0] for r in VENDOR_RULES]
_BQ_PAT   = "|".join("(?:" + r[2] + ")" for r in VENDOR_RULES)

# ─── Listas por hoja (orden EXACTO del usuario) ──────────────────────────────
VENDORS_CUAU = [
    "4E GLOBAL SAPI DE CV",            "ABSORMEX CMPC TISSUE SA DE CV",
    "ACH FOODS MEXICO S DE RL DE CV",  "AJEMEX SA DE CV",
    "AKSI HERRAMIENTAS SA DE CV",      "BIO PAPPEL SCRIBE SA DE CV",
    "BRONCOLIN SA DE CV",              "CESARFER SA CV",
    "CHURCH & DWIGHT SRL CV",          "CIA COMERC PRODIN CENTRO SA CV",
    "CIA INTERNAC COMERCIO SAPI CV",   "COLCHONES WENDY SA DE CV",
    "COMERCIALIZADORA EL ORO SA",      "CONAGRA FOODS MEXICO SA CV",
    "CONSERVAS LA COSTENA SA CV",      "CORPORACION GAIRET SA DE CV",
    "CRISA LIBBEY MEX S DE RL DE CV",  "CUETARA DISTRIBUCION SA DE CV",
    "DASAVENA GOURMET SA DE CV",       "EFFEM MEXICO INC Y CIA S NC CV",
    "ESPEJOS INTELIGENTES SA DE CV",   "FAB DE JABON LA CORONA SA CV",
    "FACTOR PESCA SA DE CV",           "FANTASY RUZ SA DE CV",
    "GANAD PROD DE LECHE PURA SA CV",  "GRUPO TAIFELDS SA DE CV",
    "HAPPY FLOWER MEXICANA SA CV",     "HENKEL CAPITAL SA DE CV",
    "HFC PRESTIGE INTERNATIONAL S D",  "HISENSE MEXICO S DE RL DE CV",
    "IMPERCAUCHO SA DE CV",            "IMPULSORA CAMPIRANO SA DE CV",
    "IND NAC DE DETERGENTES SA CV",    "INDUSTRIAS OVARB SA CV",
    "INDUSTRIAS SALCOM SA CV",         "JESSY INTERNACIONAL SA DE CV",
    "KSMV CAPITAL SAPI DE CV",         "LA MASCOTA SA CV",
    "MATTEL DE MEXICO SA CV",          "MEAD JOHNSON NUTRIC MEX SRLCV",
    "NEWELL BRANDS DE MEXICO SA CV",   "PENAFIEL BEBIDAS SA DE CV",
    "POLYCHEM SA CV",                  "PROBEMEX SA DE CV",
    "PROD ALIMENT LA MODERNA SA CV",   "PROD INTERNACIONALES MABE SACV",
    "PROXIMO NATAL SAPI DE CV",        "QUALAMEX SA CV",
    "RAMIREZ ZUNIGA LAURA",            "RECKITT BENCKISER MEXICO SA CV",
    "REGALOS SIGLO XXI SA DE CV",      "SANTUL HERRAMIENTAS SA DE CV",
    "SCHETTINO HNOS SRL CV",           "SUPER FOODS FACTORY SA DE CV",
    "TECNISPICE SA DE CV",             "TRESMONTES LUCCHETTI MEX SA CV",
    "VASCONIA BRANDS SA DE CV",        "VCT & DG MEXICO SA DE CV",
    "VIDRIERA SANTOS SA DE CV",        "CH & ML ELECTRIC MEXICO S DE R",
    "COMERCIALIZADORA 100 MEXICANA",   "PLAYERAS SOURCE SA CV",
]
...
VENDORS_N1 = [
    ...
    "CONSERVAS LA COSTENA SA CV",      "CORPORACION GAIRET SA DE CV",
    "CRISA LIBBEY MEX S DE RL DE CV",  "CUETARA DISTRIBUCION SA DE CV",
    "EFFEM MEXICO INC Y CIA S NC CV",  "ESPEJOS INTELIGENTES SA DE CV",
    "FAB DE JABON LA CORONA SA CV",    "FACTOR PESCA SA DE CV",
    "FANTASY RUZ SA DE CV",            "GANAD PROD DE LECHE PURA SA CV",
    "GRUPO TAIFELDS SA DE CV",         "HAPPY FLOWER MEXICANA SA CV",
    "HENKEL CAPITAL SA DE CV",         "HFC PRESTIGE INTERNATIONAL S D",
    "HISENSE MEXICO S DE RL DE CV",    "IMPERCAUCHO SA DE CV",
    "IMPULSORA CAMPIRANO SA DE CV",    "IND NAC DE DETERGENTES SA CV",
    "INDUSTRIAS OVARB SA CV",          "INDUSTRIAS SALCOM SA CV",
    "JESSY INTERNACIONAL SA DE CV",    "KSMV CAPITAL SAPI DE CV",
    "LA MASCOTA SA CV",                "MATTEL DE MEXICO SA CV",
    "MEAD JOHNSON NUTRIC MEX SRLCV",   "NEWELL BRANDS DE MEXICO SA CV",
    "PENAFIEL BEBIDAS SA DE CV",       "POLYCHEM SA CV",
    "PROBEMEX SA DE CV",               "PROD ALIMENT LA MODERNA SA CV",
    "PROD INTERNACIONALES MABE SACV",  "PROXIMO NATAL SAPI DE CV",
    "QUALAMEX SA CV",                  "RAMIREZ ZUNIGA LAURA",
    "RECKITT BENCKISER MEXICO SA CV",  "REGALOS SIGLO XXI SA DE CV",
    "SANTUL HERRAMIENTAS SA DE CV",    "SCHETTINO HNOS SRL CV",
    "SUPER FOODS FACTORY SA DE CV",    "TECNISPICE SA DE CV",
    "TRESMONTES LUCCHETTI MEX SA CV",  "VASCONIA BRANDS SA DE CV",
    "VCT & DG MEXICO SA DE CV",        "VIDRIERA SANTOS SA DE CV",
    "CH & ML ELECTRIC MEXICO S DE R",  "COMERCIALIZADORA 100 MEXICANA",
    "PLAYERAS SOURCE SA CV",
]

VENDORS_N2 = VENDORS_CUAU  # mismo orden y lista que CUAU

VENDORS_N3 = [
    "CESARFER SA CV",               "CIA COMERC PRODIN CENTRO SA CV",
    "CORPORACION GAIRET SA DE CV",  "CRISA LIBBEY MEX S DE RL DE CV",
    "CUETARA DISTRIBUCION SA DE CV","EFFEM MEXICO INC Y CIA S NC CV",
    "FANTASY RUZ SA DE CV",         "GRUPO TAIFELDS SA DE CV",
    "HAPPY FLOWER MEXICANA SA CV",  "INDUSTRIAS OVARB SA CV",
    "JESSY INTERNACIONAL SA DE CV", "LA MASCOTA SA CV",
    "POLYCHEM SA CV",               "PROBEMEX SA DE CV",
    "RAMIREZ ZUNIGA LAURA",         "REGALOS SIGLO XXI SA DE CV",
    "TECNISPICE SA DE CV",          "VCT & DG MEXICO SA DE CV",
    "VIDRIERA SANTOS SA DE CV",     "COMERCIALIZADORA 100 MEXICANA",
    "PLAYERAS SOURCE SA CV",
]
...
def filter_sheet(df: pd.DataFrame, cedis: list, vendors: list) -> pd.DataFrame:
    mask = df["CEDIS"].isin(cedis) & df["VENDOR"].isin(vendors)
    out  = df[mask].copy()
    out["VENDOR"] = pd.Categorical(out["VENDOR"], categories=vendors, ordered=True)
...
def make_totals(df_b: pd.DataFrame, df_e: pd.DataFrame,
                vendor_list: list) -> pd.DataFrame:
    ...
    for vendor in vendor_list:
        ...
        if not se.empty:
            ...
            row["# CITAS_ED"] = len(se)
            if not se_b.empty:
                avg_ed = round(se_b["RECIBO_HRS"].mean(), 4)
                row["RECIBO_ED_AVG"] = avg_ed
                g_ed_hrs.append(avg_ed)
            else:
...
def write_sheet(ws, df_b: pd.DataFrame, df_e: pd.DataFrame,
                df_tot: pd.DataFrame, titulo: str, fecha_ini: str, fecha_fin: str,
...
# ─── Build workbook ────────────────────────────────────────────────────────────
SHEET_CFG = [
    # (titulo, cedis, vendor_list, hdr_hex, alt_hex, tot_hex)
    ("CUAUTITLAN (N1+N2)", CEDIS_N1+CEDIS_N2, VENDORS_CUAU, "833C00","FCE4D6","F4B183"),
    ("NAVE 1",             CEDIS_N1,           VENDORS_N1,   "7B3F00","FDE9D9","F4B183"),
    ("NAVE 2",             CEDIS_N2,           VENDORS_N2,   "4A1942","F5E6F5","D5A6E0"),
    ("NAVE 3 (DET 7492)",  CEDIS_N3,           VENDORS_N3,   "1F497D","DCE6F1","9DC3E6"),
]
...
def build_workbook(df_bkhl: pd.DataFrame, df_ed: pd.DataFrame,
    ...
    fi, ff = pd.Timestamp(fecha_ini), pd.Timestamp(fecha_fin)
    db = df_bkhl[(df_bkhl["FECHA"] >= fi) & (df_bkhl["FECHA"] <= ff)].copy()
    de = df_ed  [(df_ed  ["FECHA"] >= fi) & (df_ed  ["FECHA"] <= ff)].copy()

    wb   = Workbook()
    first = True
    for titulo, cedis, vendors, hdr, alt, tot in SHEET_CFG:
        sb  = filter_sheet(db, cedis, vendors)
        se  = filter_sheet(de, cedis, vendors)
        tot_df = make_totals(sb, se, vendors)
...
print("\n[1/2] Generando JUNIO ...")
build_workbook(
    df_bkhl_all, df_ed_all,
    BASE / "bkhl_cuau_62_junio_con_ed.xlsx",
    "2026-06-01", "2026-06-30",
)

# Archivo 2 - Julio 1-10
print("\n[2/2] Generando JULIO 1-10 ...")
build_workbook(
    df_bkhl_all, df_ed_all,
    BASE / "bkhl_cuau_62_jul1_10_con_ed.xlsx",
    "2026-07-01", "2026-07-10",
)

print("\nListo! Archivos generados:")
print("  bkhl_cuau_62_junio_con_ed.xlsx")
print("  bkhl_cuau_62_jul1_10_con_ed.xlsx")
