...
var PER_LBL = {Enero:"Enero",Febrero:"Febrero",Marzo:"Marzo",Abril:"Abril",Mayo:"Mayo",Junio:"Junio",Julio:"Jul (1-3)",ytd:"YTD"};
...
function resolveViewBundle(loc, activePeriod, useSW, swPer) {
  ...
  if (cdMode) {
    ...
    if (useSW) {
      ...
      return {
        ...
        objData:   isSamsCd ? OBJ_SAMS : OBJ_AUTO,
        regions:   cityRegions,
    ...
    return {
      ...
      tblData:   DATA_CD,
      objData:   (gCanal==='sams') ? OBJ_SAMS_CD : OBJ_AUTO_CD,
  ...
  var FMT_DATA = {
    ...
    'auto':      {tbl:DATA_AUTO,      chart:DATA_AUTO_CHART,      reg:REGIONS_AUTO, title:'Autoservicios', obj:OBJ_AUTO},
    'bae':       {tbl:DATA_BAE,       chart:DATA_BAE_CHART,       reg:REGIONS_AUTO, title:'BAE',           obj:OBJ_AUTO},
